...
public class PlaceCustomerOrder extends javax.swing.JFrame {

    String loginInfo = LoginScreen.email;

    public PlaceCustomerOrder() {
        initComponents();
        AdminTF.setText(loginInfo);
    ...
    private void initComponents() {
        ...
        AdminTF = new javax.swing.JLabel();
        ...
        getContentPane().add(ReceiptPanel, new org.netbeans.lib.awtextra.AbsoluteConstraints(470, 130, 470, 570));
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(26, 212, 403, 430));
        ...
        AdminTF.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        AdminTF.setForeground(new java.awt.Color(255, 255, 255));
        AdminTF.setText("--");
        getContentPane().add(AdminTF, new org.netbeans.lib.awtextra.AbsoluteConstraints(1220, 30, -1, -1));
    ...
    private void ReceiptButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ReceiptButtonActionPerformed
        ...
        if (CartTable.getRowCount() == 0 || TotalBillTxtField.getText().equals("")) {
            JOptionPane.showMessageDialog(null, "Either Cart or total is empty!");
        } else {
            ...
            ReceiptArea.setText(ReceiptArea.getText() + "Seller Name: " + AdminTF.getText() + "\n");
            for (int i = 0; i < CartTable.getRowCount(); i++) {
...
//        CustomerName.setText("");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PlaceCustomerOrder().setVisible(true);
            }
        });
    }

    // Variables declaration - do not modify//GEN-BEGIN:variables
    private javax.swing.JLabel AdminTF;
